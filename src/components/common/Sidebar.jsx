import { BarChart2, DollarSign, Menu } from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        ...
        >
            <div className='h-full bg-maroon bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r border-gray-700'>
                <motion.button
